...
add(data)           : 연결 리스트에 데이터를 삽입하는 함수
add_with_sort(data) : 연결 리스트에 데이터를 정렬하여 삽입하는 함수
search(data)        : 연결 리스트에 데이터를 탐색하는 함수
get(data)           : 연결 리스트에 데이터를 참조하는 함수
pop()               : 연결 리스트의 데이터를 가장 최근에 저장된 데이터를 삭제하는 함수
remove(index)       : 연결 리스트의 원하는 인덱스를 삭제하는 함수
display()           : 연결 리스트의 데이터를 출력하는 함수
'''
